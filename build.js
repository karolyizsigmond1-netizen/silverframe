...
function lightboxHtml() {
  return `    <div class="lightbox" id="lightbox" role="dialog" aria-label="Képnézegető">
        ...
        <div class="lightbox-bundle-bar">
            <span class="lightbox-bundle-title"></span>
            <div class="lightbox-view-toggle">
                <button class="lv-btn lv-single active" aria-label="Egyedi nézet" title="Kép nézet">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="2" y="2" width="14" height="14" rx="1" stroke="currentColor" stroke-width="1.5"/></svg>
                </button>
                <button class="lv-btn lv-grid" aria-label="Rács nézet" title="Rács nézet">
                    <svg width="18" height="18" viewBox="0 0 18 18" fill="none"><rect x="2" y="2" width="5.5" height="5.5" rx="0.5" stroke="currentColor" stroke-width="1.5"/><rect x="10.5" y="2" width="5.5" height="5.5" rx="0.5" stroke="currentColor" stroke-width="1.5"/><rect x="2" y="10.5" width="5.5" height="5.5" rx="0.5" stroke="currentColor" stroke-width="1.5"/><rect x="10.5" y="10.5" width="5.5" height="5.5" rx="0.5" stroke="currentColor" stroke-width="1.5"/></svg>
                </button>
            </div>
        </div>
        ...
        <div class="lightbox-grid-view">
            <div class="lightbox-grid-inner"></div>
        </div>
    </div>`;
}
